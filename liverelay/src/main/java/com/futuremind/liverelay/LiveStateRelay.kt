...
/**
 * [LiveStateRelay] can be used to process states between ViewModel and LifecycleOwner.
 *
 ...
 *
 * The states passed to [LiveStateRelay] are volatile, which means that they are only passed to
